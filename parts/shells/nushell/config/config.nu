# env-vars
const FZF_PATH = "~/flake/parts/shells/nushell/config/fzf.nu"
const SESH_PATH = "~/flake/parts/shells/nushell/config/sesh.nu"
const THEME_PATH = "~/flake/parts/shells/nushell/themes/tokyonight_night.nu"
const ATUIN_PATH = "~/flake/parts/shells/nushell/config/atuin.nu"
const NIX_PATH = "~/flake/parts/shells/nushell/config/nix.nu"
const ZOXIDE_PATH = "~/flake/parts/shells/nushell/config/zoxide.nu"
const AUTO_PAIR = "~/flake/parts/shells/nushell/config/auto-pair.nu"
const MATCHIT = "~/flake/parts/shells/nushell/config/matchit.nu"
const EXTRACTOR = "~/flake/parts/shells/nushell/config/scripts/extractor.nu"
